 ...
 *       Filename:  gyro.ino
 *
 *    Description:  Demo looks at the 3 axis gyroscope readings from the L3GD20 
 *                  gyroscope and outputs them at at a configurable frequency in a
...
void setup() {
  Serial.begin(9600);
  Serial.println("Ardusat Gyroscope Demo"); 
  ...
  /* We're ready to go! */
  Serial.println("Sensor initialized, starting to read.");
}
